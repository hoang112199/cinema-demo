...
def insertMovie():
    ...
    if res == []:
        ...
        if res == []:
            return '<h5>Phim đã được thêm vào thành công</h5>\
...
def insertShow():
    ...
    if res == []:
        return '<h5>Suất chiếu được thêm vào thành công</h5>\
		<h6>Mã suất chiếu: '+str(showID)+'</h6>'
...
def setPrice():
    ...
    if res == []:
        return '<h5>Giá đã thay đổi thành công</h5>\
			<h6>Ghế Thường: '+newPrice+' VND</h6>\
			<h6>Ghế Vip: '+str(int(int(newPrice) * 1.5))+' VND</h6>'
...
def insertStaff():
    ...
    if res == []:
        ...
        if res == []:
            return '<h5>Thông tin nhân viên đã được thêm thành công</h5>\
...
def insertMember():
    ...
    if res == []:
        ...
        if res == []:
            return '<h5>Khách hàng đã được thêm vào thành công</h5>\
			<h6>Mã khách hàng: '+str(memberID)+'</h6>'
        else:
            print(res)
    else:
        print(res)
